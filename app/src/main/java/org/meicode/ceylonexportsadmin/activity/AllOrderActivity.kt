package org.meicode.ceylonexportsadmin.activity
...
import org.meicode.ceylonexportsadmin.adapter.AllOrderAdapater
...
class AllOrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Firebase.firestore.collection("allOrders").get().addOnSuccessListener {
            ...
            recyclerView.adapter =AllOrderAdapater(list, this)
        }
